...
export interface ApiLandingPageLandingPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    community: Schema.Attribute.Component<'sections.manage-community', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    getDemo: Schema.Attribute.Component<'sections.go-to-action', false>;
    info_1: Schema.Attribute.Component<'sections.detail-box', false>;
    info_2: Schema.Attribute.Component<'sections.detail-box', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    main: Schema.Attribute.Component<'sections.main', false>;
    marketing: Schema.Attribute.Component<'sections.cards-box', false>;
    name: Schema.Attribute.String;
    our_clients: Schema.Attribute.Component<'sections.clients', false>;
    ourMetrix: Schema.Attribute.Component<'sections.key-metrics', false>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    testimonial: Schema.Attribute.Component<'sections.testimonials', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
